...
const AdminSignUp = () => {
  ...
  const validateForm = () => {
    ...
    const uniqueKey = "Dal@12345";
    if (formData.uniqueKey !== uniqueKey) {
      formErrors.uniqueKey = 'Please enter the correct unique key';
    }
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label htmlFor="uniqueKey">Unique Key:</label>
          <input
            ...
            required
          />
          {errors.uniqueKey && <span className="error">{errors.uniqueKey}</span>}
        </div>
        <div className="form-group">
